  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 sm:p-10 min-h-[500px] w-full max-w-xl mx-auto">
      <div className="mb-10 text-center">
        ...
        <p className="text-white/90 font-sans leading-relaxed max-w-md mx-auto">
          Chúc mừng bạn đã hoàn thành hành trình khám phá nội tâm! Hãy để lại thông tin để chúng tôi gửi bản PDF tổng hợp các giá trị cốt lõi và hành động gợi ý về email cho bạn lưu trữ nhé.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
        ...
        >
          {isSubmitting ? 'Đang xử lý...' : 'Xem kết quả & Gửi PDF'}
        </button>
      </form>
    </div>
  );
