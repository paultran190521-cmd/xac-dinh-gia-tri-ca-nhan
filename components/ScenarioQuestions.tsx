  ...
  return (
    <div className="flex flex-col p-6 sm:p-10 min-h-[500px] w-full max-w-4xl mx-auto">
      <div className="mb-8 text-center">
        <h2 className="text-4xl font-sans text-[#DF9317] mb-4 uppercase tracking-widest font-bold">Bước 2: Phản chiếu</h2>
      ...
      <div className="flex-1 relative w-full">
        <AnimatePresence mode="wait">
          ...
          >
            <h3 className="text-2xl text-[#1992B0] font-sans font-bold uppercase tracking-widest mb-4">
              {questions[currentIndex].title}
            </h3>
            <p className="text-white/80 font-sans text-xl mb-8 leading-relaxed max-w-3xl">
            ...
            <textarea
              ...
              className="w-full flex-1 min-h-[150px] max-h-[300px] bg-[#1992B0]/10 border border-[#1992B0]/30 rounded-2xl p-6 text-white placeholder-white/40 focus:outline-none focus:border-[#DF9317] focus:ring-1 focus:ring-[#DF9317] focus:shadow-[0_0_15px_rgba(223,147,23,0.3)] transition-all resize-none font-sans text-lg"
            />
          </motion.div>
        </AnimatePresence>
      </div>

      <div className="mt-8 flex justify-between items-center z-10 w-full relative">
        <button
          onClick={handleSkip}
          className="text-white/50 hover:text-white uppercase text-xs tracking-widest font-bold transition-colors py-2"
        >
          Bỏ qua
        </button>
        <button
          onClick={handleNext}
          className="px-8 py-3 bg-[#DF9317] hover:bg-[#c47e11] text-[#104E5B] font-bold uppercase rounded-2xl text-sm tracking-widest transition-all hover:scale-105 active:scale-95 shadow-lg shadow-[#DF9317]/20"
        >
